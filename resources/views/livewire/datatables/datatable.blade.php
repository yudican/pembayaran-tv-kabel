      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex flex-row justify-center items-center">
          ...
          <div class="mx-2">
            ...
            <!-- Dropdown menu -->
            <div id="options-dropdown-bulk" class="hidden z-10 w-48 bg-white rounded divide-y divide-gray-100 shadow ">
              <ul class="p-3 space-y-3 text-sm text-gray-700" aria-labelledby="optionsDropdown">
                {{-- approve finace --}}
