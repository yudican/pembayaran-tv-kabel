<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>metode pembayarans</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.metode-pembayaran-table params="{{$route_name}}" />
        </div>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' : 'Tambah'}} metode pembayarans</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="nama_bank_pembayaran" label="Nama Bank Pembayaran" />
                        <x-text-field type="text" name="nama_rekening" label="Nama Rekening" />
                        <x-text-field type="number" name="nomor_rekening" label="Nomor Rekening" />
                    </div>
