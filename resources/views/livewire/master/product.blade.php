<div class="page-inner">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="nama_product" label="Nama Produk" />
                    <x-text-field type="number" name="harga_product" label="Harga Produk" />
                    <x-text-field type="text" name="kecepatan" label="Kecepatan Koneksi" />
