        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <x-text-field type="text" name="pelanggan" label="Nama Pelanggan" disabled />
                    @endif
                    <x-select name="product_id" label="Pilihan Produk">
                        <option value="">Select Pilihan Produk</option>
                        @foreach ($products as $product)
                        <option value="{{$product->id}}">{{$product->nama_product}} - {{$product->harga_product}}</option>
                        @endforeach
                    </x-select>
                    <x-text-field type="number" name="payment_amount" label="Jumlah Pembayaran" />
                    <x-text-field type="date" name="payment_date" label="Tanggal Pembayaran" />
